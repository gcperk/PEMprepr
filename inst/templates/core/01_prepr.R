...
get_trim_dem(aoi_bb = file.path(fid$shape_dir_1010[2],"aoi_snapped.gpkg"), 
             res = 25, out_dir = fid$cov_dir_1020[2])

get_trim_dem(res = 5)

get_trim_dem(aoi_bb = file.path(fid$shape_dir_1010[2],"aoi_ls_snap.gpkg"),
...
bec_rast <- create_bgc_template(bec_sf, field = "MAP_LABEL", template = r25,
